    ...
    return (
        <div className='relative'>
            ...
            <div className='flex items-center mt-6 font-medium'>
                ...
                bg-[var(--color-primary)] hover:bg-[var(--color-primary-dull)] transition rounded text-white cursor-pointer'>
                    Shop Now
                    <img className='md:hidden transition-transform duration-300 group-hover:translate-x-1' 
                ...
                <Link to='/products' className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
                    Explore Details
                    <img className='transition-transform duration-300 group-hover:translate-x-1' 
