    ...
    return product && (
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div onClick={() => addToCart(product._id)} className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={() => {
                            ...
                            className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white 
                            hover:bg-[var(--color-primary-dull)] transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                className="mx-auto my-16 cursor-pointer px-12 py-2.5 border rounded text-primary hover:bg-primary/10 transition">
                    See More
                </button>
            </div>
        </div>
